...
ifneq ($(TARGET_USES_AOSP_FOR_AUDIO), true)
ifneq ($(TARGET_USES_AOSP_BLUETOOTH_AUDIO), true)
PRODUCT_COPY_FILES += \
    hardware/qcom/audio/configs/msm8996/audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/audio_policy_configuration.xml \
...
PRODUCT_COPY_FILES += \
    hardware/qcom/audio/configs/msm8996/aosp_bluetooth_audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio/audio_policy_configuration.xml
    hardware/qcom/audio/configs/common/aosp_bluetooth_audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.xml
endif
endif
...
ifeq ($(TARGET_USES_AOSP_BLUETOOTH_AUDIO), true)
PRODUCT_COPY_FILES += \
