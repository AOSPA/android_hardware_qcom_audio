...
ifneq ($(TARGET_USES_AOSP_FOR_AUDIO), true)
ifneq ($(PRODUCT_USES_AOSP_BT), true)
PRODUCT_COPY_FILES += \
...
PRODUCT_COPY_FILES += \
    $(TOPDIR)hardware/qcom/audio/configs/common/aosp_audio_policy_configuration.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration.xml \
